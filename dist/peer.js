...
},{"./adapter":1,"./mediaconnection":3,"./negotiator":4,"./peer":5,"./socket":6,"./util":7,"js-binarypack":9}],3:[function(require,module,exports){
...
function Socket(secure, host, port, path, key) {
    ...
    console.log("======================================");
    console.log("socket.js >> creating socket with");
...
Socket.prototype._startWebSocket = function(id) {
    console.log("socket.js >> _startWebSocket...");
    var self = this;
    ...
    this._socket.onmessage = function(event) {
        console.log("socket.js >> onmessage");
        try {
...
var util = {
  ...
  _print: function () {
   ...
   // err : console.log.apply(console, copy);
  },
  //
...
},{"./bufferbuilder":10}],10:[function(require,module,exports){
var binaryFeatures = {};
